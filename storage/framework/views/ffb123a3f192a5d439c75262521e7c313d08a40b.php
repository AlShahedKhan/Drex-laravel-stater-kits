        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <?php if(hasPermission('language_create')): ?>
                        ...
                        <table class="table table-bordered ot-table-bg language-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <?php if(hasPermission('language_update') ||
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($row->code != 'en'): ?>
                                                        <?php if(hasPermission('language_delete')): ?>
                                                            <li>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if(hasPermission('language_update_terms')): ?>
                                                        <li>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\khelardan\resources\views/backend/languages/index.blade.php ENDPATH**/ ?>